...
| 8 | [Ops & Observability](./phase-08-ops-observability.md) | K8s deploy + tracing/metrics/logs across a request | 🔄 In progress (8a ✅ #29 · 8b ✅ #30 · 8c K8s [a ✅ #31 · b ✅ verified] · 8d CI/CD ✅ verified, PR pending) |
