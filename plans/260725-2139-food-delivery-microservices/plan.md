...
| 8 | [Ops & Observability](./phase-08-ops-observability.md) | K8s deploy + tracing/metrics/logs across a request | 🔄 In progress (8a tracing ✅ verified; 8b metrics/logs · 8c K8s · 8d CI/CD next) |
