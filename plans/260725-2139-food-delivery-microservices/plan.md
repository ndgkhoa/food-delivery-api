...
| 6 | [Analytics, Review, Config](./phase-06-analytics-review-config.md) | Rating → restaurant score; revenue dashboard; dynamic fees | 🔄 In progress (6a config #21/#22 · 6b review · 6c analytics) |
