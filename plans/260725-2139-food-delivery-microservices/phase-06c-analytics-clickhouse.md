...
- [ ] E2E: dashboards reflect produced orders; redelivery no double-count; tenant isolation (spec written, gated behind `RUN_ANALYTICS_E2E`, not yet run against a live stack)
