 ...
 * chain so the order/idempotency repositories enlist in the current
 * transaction without threading a manager through every method. Empty
 * outside a transaction — callers then fall back to the default manager.
 */
