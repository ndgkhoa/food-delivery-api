...
/**
 * Publishes the review OpenAPI spec at `/api/v1/openapi.json` and a Scalar
...
export function setupOpenApi(app: INestApplication): void {
  const config = new DocumentBuilder()
    ...
    .setDescription('Restaurant reviews and rating recompute for the food-delivery platform.')
    .setVersion('1.0')
    .addBearerAuth()
    .build();
